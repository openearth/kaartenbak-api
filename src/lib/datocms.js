...
export const datocmsRequest = curry(
  ({ query, variables, preview, token: tokenOverride, environment }) => {
    const args = [
      query,
      { first: defaultFirst, ...variables },
      preview,
      tokenOverride,
      environment,
    ];
...
export const datocmsClient = buildClient({
